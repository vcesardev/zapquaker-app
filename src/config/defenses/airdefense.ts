...
import Image13 from "../../assets/images/defenses/airdefenses/14_13.png";

export const airDefenseData: DefenseData = {
  id: "123214124",
  name: "Defesa Aérea",
  hitpoints: [
    800, 850, 900, 950, 1000, 1050, 1100, 1210, 1300, 1400, 1500, 1650, 1750,
  ],
  imageUrl: [
    Image1,
    Image2,
